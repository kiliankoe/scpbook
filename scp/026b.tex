\textbf{SCP-026 Exploration Logs}
\begin{flushleft}
Exploration Log 026-4
\end{flushleft}
\textsl{Exploration conducted by Agent \censor{XXXXXXX}}
...
"You're not going to believe this, \censor{XXXX}. It's got Agent \censor{XXXXXXXXX}'s notes up there. In her handwriting, even. We're going to have to be really careful what we bring in here.
...
\end{flushleft}
\textsl{Exploration conducted by Agent \censor{XXXXX}, accompanied by a robotic drone.}
...
"I"m heading in. There's not as much graffiti up here. A bit of debris. I'm opening one of the doors. Janitor's closet, and, hey, we've got a janitor. He's sleeping standing up. That's new. Male, seems to be in his mid-fifties. Nametag says "\censor{XXXXXXX}." A couple old broomsticks, what's left of a mop... Looks like rats have been nesting in here. They've shredded one of his pantlegs, but looks like they didn't touch the sleeper himself. What? You want samples? Eh, sure. Wouldn't be the weirdest thing I've picked up for this job. Okay, I think that's it."

Comparison with File 026-4 revealed the sleeper to be \censor{XXXX} \censor{XXXXXXXX}, former janitor in SCP-026. Later analysis of the rat feces \linebreak revealed [REDACTED]. Recommended future exploration teams wear biohazard gear.
...
The Latin was found to be a series of sentences showing different conjugations of the verb Vendo, to sell. All were found in \censor{XXXXXXX}'s Latin Primer, a textbook formerly used by the school. The baseball bat was aluminum, and analysis of the fingerprints was inconclusive.
...
The video feed showed the next door was thirty feet away. The total elapsed time from one door to the next was five minutes, in which time Agent \censor{XXXXX} meandered toward the end of the hallway. No anomalous activity was observed while he was standing still. When he neared the end of the hallway, Agent \censor{XXXXX} turned around and quickly returned to the beginning of the hallway.
\newpage
...
The robot was able to reach the end of the hallway with no problems. Agent \censor{XXXXX} attempted to follow, but was unable to keep a straight line to the end of the hallway.
